...
const schedule = [
  { time: '8:00 AM', event: 'Doors open with breakfast' },
  { time: '8:30 AM', event: 'Opening ceremony' },
  { time: '9:00 AM', event: 'Team formation and brainstorming' },
  { time: '9:30 AM', event: 'Hacking begins!' },
  { time: '9:30 PM', event: 'Workshop 1' },
  { time: '1:00 PM', event: 'Lunch' },
  { time: '2:00 PM', event: 'Continue hacking' },
  { time: '6:00 PM', event: 'Dinner' },
  { time: '6:30 PM', event: 'Final touches' },
  { time: '7:15 PM', event: 'Demos!' },
  ...
  return (
    ...
    >
      <Head>
        ...
        <title>Scrapyard New Jersey</title>
      </Head>
      <Flag />
      <Box
        sx={{
      ...
      >
        ...
        >
          <Image
            ...
            src="\city\new-jersey\scrapyard-title-nj.png"
            alt="Scrapyard"
          />
        </Box>
        <Box
        ...
        <Link
          ...
          href="https://forms.hackclub.com/scrapyard-signup?event=new-jersey"
          target="_blank"
        >
          <Box
            sx={{
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              Jersey needs you and your scrappy ideas!
            </p>
          </Box>
        </Box>
        <Box
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change [EXAMPLECITY] to your event's city */}
            WHAT'S HAPPENING AT SCRAPYARD NEW JERSEY?
          </Heading>
        </Box>
        <Heading
          as="h2"
      ...
      >
          ...
          {Object.entries({
            ...
            'What if my parents are concerned?': (
              <>
                ...
                <Link href="mailto:nj.new-jersey@scrapyard.hackclub.com">
                  {/* TODO: Change this email to your event's email */}
                  nj.new-jersey@scrapyard.hackclub.com
                </Link>{' '}
                for questions.
              </>
            ),
            'What if I have more questions?': (
              <>
                ...
                Contact us! Feel free to reach out to us in the #scrapyard-nj
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              SIGN UP FOR SCRAPYARD NEW JERSEY
            </Heading>
          </Box>
        </Link>
        <Heading
