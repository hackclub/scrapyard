  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Scrapyard Toronto is a 24 Hour event - HERE'S THE ROUGH SCHEDULE!
        </Heading>
        <Box
          sx={{
            display: 'flex',
            ...
            {[
              {
                ...
                message:
                  'What I’m looking forward to: I’m so excited to see all of your excited faces when presenting your projects and to see the very many cool ideas even though we’d all be sleep deprived.',
                quote: 'Sometimes doing nothing is the best thing to do!!',
                img: 'https://cdn.hack.pet/U084RT5K678/Screenshot%202025-03-05%20212309.png'
              },
              {
                name: 'Itai',
                grade: '12th Grade',
            ...
            {[
              {
                name: 'InspireTech',
                description:
                  'InspireTech is a one-of-a-kind platform that provides comprehensive lessons, cloud-computing capabilities, and a class-management system. InspireTech is the perfect tool for teachers and students alike.',
                logo: 'https://cdn.hack.pet/U084RT5K678/Shania+Sheth+-+InspireTech+Logo+(4000+%C3%97+2560+px)+-+White+on+Black.jpg'
              },
              {
                name: 'System76',
                description:
