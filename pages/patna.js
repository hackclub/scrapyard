...
// Updated schedule for the Patna event
const schedule = [
  { time: '08:00 AM', event: 'Check-in & Welcome' },
  { time: '08:30 AM', event: 'Opening Ceremony' },
  { time: '09:00 AM', event: 'Hacking Begins' },
  { time: '12:00 PM', event: 'Break' },
  { time: '12:30 PM', event: 'Hacking Continues' },
  { time: '02:30 PM', event: 'Break & Activities' },
  { time: '03:30 PM', event: 'Workshops & Fun Sessions' },
  { time: '05:00 PM', event: 'Final Hacking Sprint' },
  { time: '06:30 PM', event: 'Project Submissions & Setup' },
  { time: '07:00 PM', event: 'Project Demos & Judging' },
  { time: '07:30 PM', event: 'Closing Ceremony & Awards' },
  { time: '08:00 PM', event: 'Networking & Wrap-up' },
]
    ...
    >
      ...
      >
        ...
        >
         ...
         {/* Image Section */}
         <img
  src="/elements/Come and join us to Meet some cool People Like them (1).png"
  alt="Join us to meet cool people"
  style={{
    width: "30%",  // Adjust size as needed
    height: "60%",
    position: "absolute",
    right: "68%", // Moves the image towards the right
...
/>
        ...
        {/* Sign Up Button */}
        <Link
          href="https://forms.hackclub.com/scrapyard-signup?event=patna"
          target="_blank"
        >
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              What's Scrapyard Patna?
            </Heading>
            <p style={{ fontSize: '1.5em' }}>
              Scrapyard Patna is a hackathon for high schoolers happening in Patna, where you can make the stupidest things you can think of! Anything, from a
              <Link href="https://www.youtube.com/watch?v=PnK4gzO6S3Q"> lamp that flashes faster the slower you type</Link>
              , to those ideas that you wouldn't dare to consider to be useful, goes at Scrapyard. No matter your experience, Scrapyard Patna needs you and your scrappy ideas!
            </p>
          </Box>
        </Box>
        ...
        <Box sx={{ textAlign: 'center', mt: 5 }}>
          <Text sx={{ fontSize: '3.5em', mb: 10 }}>Stay Connected(click)</Text>
          <Link href="https://instagram.com/scrapyard_patna" target="_blank" sx={{ mx: 2 }}>
            <Image src="/icons/instagram.svg.svg" alt="Instagram" width={130} height={130} />
          </Link>
          <Link href="https://hackclub.slack.com/archives/C08AGCCLMJL" target="_blank" sx={{ mx: 2 }}>
            <Image src="/icons/Slack_Technologies_Logo.svg.svg" alt="Slack" width={130} height={130} />
          </Link>
          <Link href="https://forms.hackclub.com/scrapyard-signup?event=patna" target="_blank" sx={{ mx: 2 }}>
            <Image src="/icons/Screenshot 2025-02-21 040321.svg" alt="Sign Up" width={130} height={130} />
          </Link>
          <Link href="mailto:pulkitparmar09@gmail.com" sx={{ mx: 2 }}>
            <Image src="/icons/Gmail_icon_(2020).svg.svg" alt="Email" width={130} height={130} />
          </Link>
        </Box>
      </Box>
      ...
      >
        ...
        >
          {Object.entries({
            ...
            'What do I need?': (
              <>
                Your laptop, chargers, and an open mind! If you're going to an overnight event, bring toiletries and sleeping bags too. Additionally, if you plan to work on a hardware project, bring the tools you'll need.
              </>
            ),
            ...
            'What if my parents are concerned?': (
              <>
                We’re here to help! Our parents guide will be released soon, but they can reach out to us at{' '}
                <Link href="mailto:pulkitparmar09@gmail.com">
                  pulkitparmar09@gmail.com
                </Link>
                for questions.
              </>
            ),
            'What if I have more questions?': (
              <>
                Contact us! Feel free to reach out to us in the <Link href="https://hackclub.slack.com/archives/C08AGCCLMJL">#scrapyard</Link> channel on the Hack Club slack or email us at{' '}
                <Link href="mailto:pulkitparmar09@gmail.com">
                  pulkitparmar09@gmail.com
                </Link>
                .
...
>
        ...
        {/* Sign Up Button at the End Section */}
        <Link
          href="https://forms.hackclub.com/scrapyard-signup?event=patna"
          target="_blank"
        >
